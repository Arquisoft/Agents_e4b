...
public class Application {
	...
	public CommandLineRunner initDB(ParticipantRepository repository) throws ParseException {
		...
		return (args) -> {
			...
			repository.save(new Agent("Paco Gomez", "123456", "paco@hotmail.com", "12345678B", "Calle Uría", "Person", 1));
			...
			// Inserción en la base de datos
			repository.save(new Agent("María Sánchez", "123456", "maria@gmai.com", "33445566E", "Avenida Santander", "Person", 1));
