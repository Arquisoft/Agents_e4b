...
public class MainTest {
	...
	public void T1domainModelEqualsTest() {
		Agent agent1 = getAgent.getAgent("12345678B");
		Agent agent2 = getAgent.getAgent("12345678555B");
		Agent agent3 = getAgent.getAgent("12345678B");
		Agent agent4 = getAgent.getAgent("87654321B");
	...
	public void T2domainModelToString() {
		...
		assertEquals(
				agent1.toString(),
				"Agent [id=" + agent1.getId() + ", nombre="
						+ agent1.getNombre() + ", password="
						+ agent1.getPassword() + ", email=" + agent1.getEmail()
						+ ", identificador=" + agent1.getIdentificador()
						+ ", direccion=" + agent1.getDireccion() + ", kind="
						+ agent1.getKind() + ", kindCode="
						+ agent1.getKindCode() + "]");
	}
	...
	public void T4agentExistAndCorrectPasssword() {
		...
		response = template.postForEntity(userURI, new PeticionInfoREST(
				"12345678B", "123456", "Person"), String.class);
		assertThat(
				response.getBody(),
				equalTo("{\"firstName\":\"Paco Gomez\",\"email\":\"paco@hotmail.com\",\"direccion\":\"Calle Uria\",\"kind\":\"Person\",\"kindCode\":1,\"id\":\"12345678B\"}"));

		response = template.postForEntity(userURI, new PeticionInfoREST(
				"87654321B", "123456", "Person"), String.class);
		assertThat(
				response.getBody(),
				equalTo("{\"firstName\":\"Pepe Fernandez\",\"email\":\"pepe@gmail.com\",\"direccion\":\"Calle Principal\",\"kind\":\"Person\",\"kindCode\":1,\"id\":\"87654321B\"}"));

		response = template.postForEntity(userURI, new PeticionInfoREST(
				"11223344C", "123456", "Person"), String.class);
		assertThat(
				response.getBody(),
				equalTo("{\"firstName\":\"Carmen Lopez\",\"email\":\"carmen@yahoo.com\",\"direccion\":\"Calle Calvo Sotelo\",\"kind\":\"Person\",\"kindCode\":1,\"id\":\"11223344C\"}"));
	...
	public void T5agentDoNotExist() {
		...
		response = template.postForEntity(userURI, new PeticionInfoREST(
				"136543654E", "ajksdkje", "Person"), String.class);
		assertThat(response.getBody(), equalTo(userNotFound));

		response = template.postForEntity(userURI, new PeticionInfoREST(
				"66666666X", "shcxhqw", "Person"), String.class);
		assertThat(response.getBody(), equalTo(userNotFound));
	}
	...
	public void T6incorrectPassword() {
		...
		response = template.postForEntity(userURI, new PeticionInfoREST(
				"12345678B", "1235222226", "Person"), String.class);
		assertThat(response.getBody(), equalTo(incorrectPassword));

		response = template.postForEntity(userURI, new PeticionInfoREST(
				"87654321B", "12965346", "Person"), String.class);
		assertThat(response.getBody(), equalTo(incorrectPassword));

		response = template.postForEntity(userURI, new PeticionInfoREST(
				"11223344C", "134ddd56", "Person"), String.class);
		assertThat(response.getBody(), equalTo(incorrectPassword));

		response = template.postForEntity(userURI, new PeticionInfoREST(
				"22334455D", "234522222226", "Person"), String.class);
		assertThat(response.getBody(), equalTo(incorrectPassword));
	}
	...
	public void T7emptyUser() {
		...
		response = template.postForEntity(userURI, new PeticionInfoREST("",
				"1235222226", "Person"), String.class);
		assertThat(response.getBody(), equalTo(emptyUser));

		response = template.postForEntity(userURI, new PeticionInfoREST("",
				"226", "Person"), String.class);
		assertThat(response.getBody(), equalTo(emptyUser));

		response = template.postForEntity(userURI, new PeticionInfoREST("",
				"1", "Person"), String.class);
		assertThat(response.getBody(), equalTo(emptyUser));

		response = template.postForEntity(userURI, new PeticionInfoREST("",
				"hhh", "Person"), String.class);
		assertThat(response.getBody(), equalTo(emptyUser));
	}
	 ...
	 * 
	 * @Test public void T8invalidEmail() { ResponseEntity<String> response =
	 * template.getForEntity(base.toString(), String.class); String userURI =
	 * base.toString() + "/user"; String wrongEmailStyle =
	 * "{\"reason\": \"Wrong mail style\"}"; response =
	 * template.postForEntity(userURI, new PeticionInfoREST("ajsjc", ""),
	 * String.class); assertThat(response.getBody(), equalTo(wrongEmailStyle));
	 * 
	 * response = template.postForEntity(userURI, new
	 * PeticionInfoREST("jxjsjd@", ""), String.class);
	 * assertThat(response.getBody(), equalTo(wrongEmailStyle));
	 * 
	 * response = template.postForEntity(userURI, new
	 * PeticionInfoREST("chdgetc@chhsy", ""), String.class);
	 * assertThat(response.getBody(), equalTo(wrongEmailStyle));
	 * 
	 * response = template.postForEntity(userURI, new
	 * PeticionInfoREST("sjhwuwsc", ""), String.class);
	 * assertThat(response.getBody(), equalTo(wrongEmailStyle)); }
	 */
	...
	public void T9emptyPassword() {
		...
		response = template.postForEntity(userURI, new PeticionInfoREST(
				"12345678B", "", "Person"), String.class);
		assertThat(response.getBody(), equalTo(emptyPassword));

		response = template.postForEntity(userURI, new PeticionInfoREST(
				"87654321B", "", "Person"), String.class);
		assertThat(response.getBody(), equalTo(emptyPassword));

		response = template.postForEntity(userURI, new PeticionInfoREST(
				"11223344C", "", "Person"), String.class);
		assertThat(response.getBody(), equalTo(emptyPassword));

		response = template.postForEntity(userURI, new PeticionInfoREST(
				"22334455D", "", "Person"), String.class);
		assertThat(response.getBody(), equalTo(emptyPassword));
	}
	...
	public void TemptyKind() {
		...
		response = template.postForEntity(userURI, new PeticionInfoREST(
				"12345678B", "123456", ""), String.class);
		assertThat(response.getBody(), equalTo(emptyKind));

		response = template.postForEntity(userURI, new PeticionInfoREST(
				"87654321B", "123456", ""), String.class);
		assertThat(response.getBody(), equalTo(emptyKind));

		response = template.postForEntity(userURI, new PeticionInfoREST(
				"11223344C", "123456", ""), String.class);
		assertThat(response.getBody(), equalTo(emptyKind));

		response = template.postForEntity(userURI, new PeticionInfoREST(
				"22334455D", "123456", ""), String.class);
		assertThat(response.getBody(), equalTo(emptyKind));
	}
	...
	public void T10emailRequiredChange() {
		...
		response = template.postForEntity(userURI, new PeticionChangeEmailREST(
				"", "", ""), String.class);
	...
	public void T14newInvalidEmailChange() {
		...
		response = template.postForEntity(userURI, new PeticionChangeEmailREST(
				"paco@hotmail.com", "", "xhhuwi"), String.class);
		assertThat(response.getBody(), equalTo(wrongEmailStyle));

		response = template.postForEntity(userURI, new PeticionChangeEmailREST(
				"paco@hotmail.com", "", "fhgythf@"), String.class);
		assertThat(response.getBody(), equalTo(wrongEmailStyle));

		response = template.postForEntity(userURI, new PeticionChangeEmailREST(
				"paco@hotmail.com", "", "fhfyg@hotmail"), String.class);
		assertThat(response.getBody(), equalTo(wrongEmailStyle));
	}
	...
	public void T15emailChangeUserNotFound() {
		...
		response = template.postForEntity(userURI, new PeticionChangeEmailREST(
				"pao@hotmail.com", "123456", "pac@hotmail.com"), String.class);
		assertThat(response.getBody(), equalTo(userNotFound));

		response = template.postForEntity(userURI, new PeticionChangeEmailREST(
				"pee@gmail.com", "123456", "pepe@hotmail.com"), String.class);
		assertThat(response.getBody(), equalTo(userNotFound));

		response = template.postForEntity(userURI, new PeticionChangeEmailREST(
				"pa@hotmail.com", "123456", "fhfyg@hotmail.com"), String.class);
		assertThat(response.getBody(), equalTo(userNotFound));
	}
	...
	public void T16sameEmailErrorChange() {
		...
		response = template.postForEntity(userURI, new PeticionChangeEmailREST(
				"paco@hotmail.com", "", "paco@hotmail.com"), String.class);
		assertThat(response.getBody(), equalTo(sameEmail));

		response = template.postForEntity(userURI, new PeticionChangeEmailREST(
				"pepe@gmail.com", "", "pepe@gmail.com"), String.class);
		assertThat(response.getBody(), equalTo(sameEmail));

		response = template.postForEntity(userURI, new PeticionChangeEmailREST(
				"carmen@yahoo.com", "", "carmen@yahoo.com"), String.class);
		assertThat(response.getBody(), equalTo(sameEmail));
	}
	...
	public void T17emailRequiredPasswordChange() {
		...
		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("", "", ""), String.class);
		assertThat(response.getBody(), equalTo(emptyEmail));

		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("	", "chsh", ""), String.class);
		assertThat(response.getBody(), equalTo(emptyEmail));

		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("", "dfhe", "dhdgx"),
				String.class);
		assertThat(response.getBody(), equalTo(emptyEmail));
	}
	...
	public void T18inValidRequiredPasswordChange() {
		...
		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("shdgr", "", ""), String.class);
		assertThat(response.getBody(), equalTo(wrongEmailStyle));
		...
		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("shdgr@hotmail", "", ""),
				String.class);
		assertThat(response.getBody(), equalTo(wrongEmailStyle));
	}
	...
	public void T19passwordRequiredPasswordChange() {
		...
		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("paco@hotmail.com", "", ""),
				String.class);
		assertThat(response.getBody(), equalTo(passwordRequired));

		response = template
				.postForEntity(userURI, new PeticionChangePasswordREST(
						"paco@hotmail.com", "", "dkdddd"), String.class);
		assertThat(response.getBody(), equalTo(passwordRequired));

		response = template
				.postForEntity(userURI, new PeticionChangePasswordREST(
						"paco@hotmail.com", "", "dkejd"), String.class);
		assertThat(response.getBody(), equalTo(passwordRequired));
	}
	...
	public void T20newPasswordRequiredPasswordChange() {
		...
		response = template
				.postForEntity(userURI, new PeticionChangePasswordREST(
						"paco@hotmail.com", "djfhr", ""), String.class);
		assertThat(response.getBody(), equalTo(passwordRequired));

		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("paco@hotmail.com", "djvhrhc",
						""), String.class);
		assertThat(response.getBody(), equalTo(passwordRequired));
	...
	public void T21samePasswordChange() {
		...
		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("paco@hotmail.com", "djfhr",
						"djfhr"), String.class);
		assertThat(response.getBody(), equalTo(passwordRequired));

		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("paco@hotmail.com", "djvhrhc",
						"djvhrhc"), String.class);
		assertThat(response.getBody(), equalTo(passwordRequired));

		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("paco@hotmail.com", "dkejd",
						"dkejd"), String.class);
		assertThat(response.getBody(), equalTo(passwordRequired));
	}
	...
	public void T22notFoundAgentPasswordChange() {
		...
		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("pac@hotmail.com", "djfhr",
						"djfhrtt"), String.class);
		assertThat(response.getBody(), equalTo(userNotFound));

		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("martin@hotmail.com", "djvhrhc",
						"tt"), String.class);
		assertThat(response.getBody(), equalTo(userNotFound));

		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("juan@hotmail.com", "dkejd",
						"tt"), String.class);
		assertThat(response.getBody(), equalTo(userNotFound));
	}
	...
	public void T23notSamePasswordChange() {
		...
		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("pepe@gmail.com", "djvhrhc",
						"djvhrhc"), String.class);
		assertThat(response.getBody(), equalTo(passwordIncorrect));

		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("carmen@yahoo.com", "dkejd",
						"dkejd"), String.class);
		assertThat(response.getBody(), equalTo(passwordIncorrect));
	}
...
>>>>>>> refs/remotes/origin/master
	...
	public void emailChangeCorrect() {
		...
		response = template.postForEntity(userURI, new PeticionChangeEmailREST(
				"12345678B", "paco@hotmail.com", "123456", "pac@hotmail.com"),
				String.class);
		...
		response = template.postForEntity(userURI, new PeticionChangeEmailREST(
				"87654321B", "pepe@gmail.com", "123456", "pepe@hotmail.com"),
				String.class);
		assertThat(response.getBody(), equalTo(correctChange));

		correctChange = "{\"agent\":\"fhfyg@hotmail.com\",\"message\":\"email actualizado correctamente\"}";
		response = template.postForEntity(userURI,
				new PeticionChangeEmailREST("11223344C", "carmen@yahoo.com",
						"123456", "fhfyg@hotmail.com"), String.class);
		assertThat(response.getBody(), equalTo(correctChange));
	}
	...
	public void correctPasswordChange() {
		...
		response = template.postForEntity(userURI,
				new PeticionChangePasswordREST("22334455D", "isabel@gmail.com",
						"123456", "djfhr"), String.class);
	...
	public void emailChangeCorrectXML() {
		...
		response = template.postForEntity(userURI,
				new PeticionChangeEmailREST("11223344C", "fhfyg@hotmail.com",
						"123456", "carmen@yahoo.com"), String.class);
		assertThat(response.getBody(), equalTo(correctChange));
	}
